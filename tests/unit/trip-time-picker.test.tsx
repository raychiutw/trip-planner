 ...
 *   - Trigger always shows HH:MM when value set
 *   - Popover opens with 24-hour + minute columns
 *   - Clicking hour/minute cell triggers onChange with new value
 *   - is-selected class + minuteStep
 *   - System/locale 12-hour preference does not change the controls
 */
...
describe('TripTimePicker（24h）', () => {
  ...
  it('keeps 24-hour controls when the system prefers a 12-hour clock', () => {
    ...
    expect(document.querySelector('[data-period]')).toBeNull();
  });
