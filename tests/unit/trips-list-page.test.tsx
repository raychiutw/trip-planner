...
describe('TripsListPage', () => {
  it('shows loading initially', () => {
    ...
    render(<MemoryRouter initialEntries={['/trips']}><TripsListPage /></MemoryRouter>);
  ...
  it('trailing 新增行程 card present when trips exist', async () => {
  ...
  it('mobile + ?selected=okinawa: embedded TripPage replaces card grid', async () => {
    mockMatchMedia(false);
    vi.stubGlobal('fetch', mockApi([{ tripId: 'okinawa' }], SAMPLE));
    render(<MemoryRouter initialEntries={['/trips?selected=okinawa']}><TripsListPage /></MemoryRouter>);
