/**
 * map-page-logo.test.tsx — F006 TDD red test (MapPage)
 *
 * 驗證：MapPage topbar 含 <TriplineLogo>（<a href="/"> with Tripline aria-label）。
 */
...
function renderPage() {
  return render(
    <MemoryRouter initialEntries={['/trip/test-trip/map']}>
      <MapPage />
    </MemoryRouter>,
  );
}

describe('MapPage — topbar 含 TriplineLogo (F006)', () => {
