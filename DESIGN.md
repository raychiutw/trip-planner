...
**Audit 結束（2026-05-03）：6 個違規 modal 全數遷移完成。剩 P3 confirm-modal cleanup（AccountPage logout / ConnectedAppsPage revoke / DeveloperAppsPage secret-display 改用標準化 `<ConfirmModal>` 元件，不算違規但風格不一致）。**
