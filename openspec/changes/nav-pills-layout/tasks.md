...
- [ ] 2.2 手動檢查：桌機 ≥1200px 視窗，確認 sticky-nav 全寬填滿，pills 置中，D1/D10 等寬，箭頭不與 pill 重疊
- [ ] 2.3 手動檢查：桌機 768px～1199px，確認 sticky-nav 仍有 max-width 限制並置中
- [ ] 2.4 手動檢查：多天行程（≥13 天）右箭頭與最後一顆 pill 有足夠間距
