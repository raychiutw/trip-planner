# terracotta-page-layout Specification

## Purpose
Define the V2 Terracotta page layout contract for the main app surfaces: unified TitleBar chrome, full-bleed map layout, no-emoji map markers, typed entry cards, form-first NewTripModal, loading/empty states, and per-page titlebar actions.
