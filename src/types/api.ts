...
export const ErrorCode = {
  ...
  AI_DATA_CONSENT_REQUIRED: 'AI_DATA_CONSENT_REQUIRED',
  AI_DATA_CONSENT_OWNER_REQUIRED: 'AI_DATA_CONSENT_OWNER_REQUIRED',
...
export const ERROR_MESSAGES: Record<ErrorCodeType, string> = {
  ...
  AI_DATA_CONSENT_REQUIRED: '請先閱讀並同意目前的 AI 資料處理說明',
  AI_DATA_CONSENT_OWNER_REQUIRED: '行程擁有者也需要同意目前的 AI 資料處理說明',
