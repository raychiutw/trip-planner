...
.account-sheet-close {
  /* AccountPage's sticky TitleBar overlaps the button at both viewport sizes. */
  position: absolute; top: calc(8px + env(safe-area-inset-top, 0px)); right: 12px;
  z-index: calc(var(--z-sticky-nav, 200) + 10);
